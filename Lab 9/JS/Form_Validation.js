...
function checkCPass() {
    if (document.getElementById("cpass").value == "") {
        document.getElementById("cpassErr").innerHTML = "*Confirm Password cannot be blank";
        document.getElementById("cpass").style.borderColor = "red";
    } else if (document.getElementById("cpass").value != document.getElementById("pass").value) {
        document.getElementById("cpassErr").innerHTML = "*Password and confirm password does not match";
        document.getElementById("cpass").style.borderColor = "red";
    } else {
        document.getElementById("cpassErr").innerHTML = "";
        document.getElementById("cpass").style.borderColor = "purple";
    }
}
